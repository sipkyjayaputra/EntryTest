<a href="javascript:void(0)" data-toggle="tooltip"  data-id="{{ $id }}" title="{{ $name }}" class="show-button btn btn-success view-product">
...
<a href="javascript:void(0);" data-toggle="tooltip" title="{{ $name }}" data-id="{{ $id }}" class="delete btn btn-danger">
